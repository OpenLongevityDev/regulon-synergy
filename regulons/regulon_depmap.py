...
Two regulon representations are produced. The fixed CollecTRI representation\nis the primary regulon input used by the synergy predictor; the contextualized\nrepresentation is retained as a separate exploratory/diagnostic branch:
...
DEFAULT_OUTDIR = ROOT / "regulons" / "regulon_results_ulm"
